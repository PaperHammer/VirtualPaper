...
namespace VirtualPaper.UI.CommServers
{
    public class TrayCommand : IDisposable
    {
        public TrayCommand(
             WpNavSettingsViewModel wpNavSettginsViewModel)
        {
        ...
        private WpNavSettingsViewModel _wpNavSettginsViewModel;
    }
}
