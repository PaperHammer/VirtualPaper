...
namespace VirtualPaper.UIComponent.ViewModels {
    class DetailsViewModel {
        ...
        private void InitText() {
            Details_TextResolution = _localizer.GetLocalizedString(Constants.LocalText.DetailedInfo_TextResolution);
            Details_TextAspectRadio = _localizer.GetLocalizedString(Constants.LocalText.DetailedInfo_TextAspectRadio);
            Details_TextFileExtension = _localizer.GetLocalizedString(Constants.LocalText.DetailedInfo_TextFileExtension);
            Details_TextFileSize = _localizer.GetLocalizedString(Constants.LocalText.DetailedInfo_TextFileSize);
            Details_TextVersionInfo = _localizer.GetLocalizedString(Constants.LocalText.DetailedInfo_TextVersionInfo);
        }
