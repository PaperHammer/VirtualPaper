...
using VirtualPaper.GalleryPanel.Views;

// To learn more about WinUI, the WinUI project structure,
// and more about our project templates, see: http://aka.ms/winui-project-info.

namespace VirtualPaper.GalleryPanel {
    /// <summary>
    /// An empty page that can be used on its own or navigated to within a Frame.
    /// </summary>
    public sealed partial class Gallery : Page, IGalleryPanelBridge {
        internal static Gallery Instance { get; private set; }

        public Gallery() {
            Instance = this;
            this._currentPanel = GalleryPanelState.WallpaperLib;
            this.InitializeComponent();
        }

        #region bridge
        public void ChangePanelState(GalleryPanelState nextPanel, object data) {
            _sharedData = data;
        ...
        private void NavigetBasedState(GalleryPanelState nextPanel) {
            CrossThreadInvoker.InvokeOnUiThread(() => {
                _currentPanel = nextPanel;

                Type targetPageType;
                switch (_currentPanel) {
                    case GalleryPanelState.WallpaperLib:
                        targetPageType = typeof(WallpaperLib);
                        break;
                    default:
                        return;
                }
        ...
        private GalleryPanelState _currentPanel;
