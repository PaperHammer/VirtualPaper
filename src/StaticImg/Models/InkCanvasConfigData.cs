...
//            set {
//                if (WindowConsts.IsDoubleValueEqual(_canvasZoom, value)) return;
//                _canvasZoom = value;
//                OnPropertyChanged();
//            }
//        }
...
//            if (e.PropertyName == nameof(InkCanvasData.IsVisible)) {
...
//            var idx = Layers.FindIndex(x => x.Tag == itemTag);
//            if (idx < 0) return null;

//            var layer = Layers[idx].Clone();
...
//            int idx = Math.Max(0, Math.Min(pos, Layers.Count - 1));
//            this.Layers.Insert(idx, data);
...
//            //MainPage.Instance.UndoRedo.RecordCommand(
//            //    execute: async () => {
