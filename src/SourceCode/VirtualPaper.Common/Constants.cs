namespace VirtualPaper.Common {
    public static class Constants {
        ...
        public static class LocalText {
            ...
            public static string Settings_WpNav_Text_WpArrange { get; } = "Settings_WpNav_Text_WpArrange";
            public static string Settings_WpNav_VpScreenSaver__effectBubble { get; } = "Settings_WpNav_VpScreenSaver__effectBubble";
            public static string Settings_WpNav_VpScreenSaver__effectNone { get; } = "Settings_WpNav_VpScreenSaver__effectNone";
            public static string Settings_WpNav_VpScreenSaver_Add { get; } = "Settings_WpNav_VpScreenSaver_Add";
            public static string Settings_WpNav_VpScreenSaver_DynamicEffects { get; } = "Settings_WpNav_VpScreenSaver_DynamicEffects";
            public static string Settings_WpNav_VpScreenSaver_DynamicEffectsExplain { get; } = "Settings_WpNav_VpScreenSaver_DynamicEffectsExplain";
            public static string Settings_WpNav_VpScreenSaver_RunningLock { get; } = "Settings_WpNav_VpScreenSaver_RunningLock";
            public static string Settings_WpNav_VpScreenSaver_RunningLockExplain { get; } = "Settings_WpNav_VpScreenSaver_RunningLockExplain";
            public static string Settings_WpNav_VpScreenSaver_ScreenSaver { get; } = "Settings_WpNav_VpScreenSaver_ScreenSaver";
            public static string Settings_WpNav_VpScreenSaver_ScreenSaverExplain { get; } = "Settings_WpNav_VpScreenSaver_ScreenSaverExplain";
            public static string Settings_WpNav_VpScreenSaver_ScreenSaverStatu_Off { get; } = "Settings_WpNav_VpScreenSaver_ScreenSaverStatu_Off";
            public static string Settings_WpNav_VpScreenSaver_ScreenSaverStatu_On { get; } = "Settings_WpNav_VpScreenSaver_ScreenSaverStatu_On";
            public static string Settings_WpNav_VpScreenSaver_SeekFromList { get; } = "Settings_WpNav_VpScreenSaver_SeekFromList";
            public static string Settings_WpNav_VpScreenSaver_WaitingTime { get; } = "Settings_WpNav_VpScreenSaver_WaitingTime";
            public static string Settings_WpNav_VpScreenSaver_WhiteListExplain { get; } = "Settings_WpNav_VpScreenSaver_WhiteListExplain";
            public static string Settings_WpNav_VpScreenSaver_WhiteListTitle { get; } = "Settings_WpNav_VpScreenSaver_WhiteListTitle";
            public static string Settings_WpNav_WpArrange_Duplicate { get; } = "Settings_WpNav_WpArrange_Duplicate";
            public static string Settings_WpNav_WpArrange_DuplicateExplain { get; } = "Settings_WpNav_WpArrange_DuplicateExplain";
            public static string Settings_WpNav_WpArrange_Expand { get; } = "Settings_WpNav_WpArrange_Expand";
            public static string Settings_WpNav_WpArrange_ExpandExplain { get; } = "Settings_WpNav_WpArrange_ExpandExplain";
            public static string Settings_WpNav_WpArrange_Per { get; } = "Settings_WpNav_WpArrange_Per";
            public static string Settings_WpNav_WpArrange_PerExplain { get; } = "Settings_WpNav_WpArrange_PerExplain";
