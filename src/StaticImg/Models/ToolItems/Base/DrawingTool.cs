...
//using Workloads.Creation.StaticImg.Models.StructureData;
...
//        //    if (!_brushCache.TryGetValue((_thickness, _blendedColor), out _brush)) {
//        //        var renderTarget = new CanvasRenderTarget(
//        //            MainPage.Instance.SharedDevice, _thickness, _thickness, data.Size.Dpi,
//        //            RenderTarget.Format,
//        //            RenderTarget.AlphaMode);
//        //        using (var _tmpDs = renderTarget.CreateDrawingSession()) {
//        //            _tmpDs.Blend = CanvasBlend.Copy;
//        //            _tmpDs.FillCircle(_thickness / 2, _thickness / 2, _thickness / 2, _blendedColor);
//        //        }
//        //        _brushCache[(_thickness, _blendedColor)] = renderTarget;
//        //        _brush = renderTarget;
//        //    }
//        //}
...
//            _renderableStrokes.Clear();
//            _coveredStrokeSegments.Clear();
//            var pos = e.Pointer.Position;
//            _currentSegment = new StrokeSegment(new StrokePoint(pos, _blendedColor.ToByteArgb()), _thickness);
//            _coveredSegment = new StrokeSegment(new StrokePoint(pos, RenderTarget.GetPixelBytes((int)pos.X, (int)pos.Y, _thickness, _thickness)), _thickness);
//            _pointerQueue.Clear();
...
//            CommitContentChange(
//                [.. _renderableStrokes],
//                [.. _coveredStrokeSegments],
//                BrushShape.Circle,
//                data.InkDatas.First(x => x.Tag == data.SelectedInkCanvas.Tag).RenderData.RenderTarget);
//            _renderableStrokes.Clear();
//            _coveredStrokeSegments.Clear();
...
//                _renderableStrokes.AddLast(_currentSegment);
//                _coveredStrokeSegments.AddLast(_coveredSegment);
//                //var dirtyRegion = CalculateSegmentBoundsSIMD(_tmpStroke);
//                using (var ds = RenderTarget.CreateDrawingSession()) {
//                    _currentSegment.Draw(ds, BrushShape.Circle, RenderTarget.Format, RenderTarget.AlphaMode);
//                    //DrawSegment(ds, _tmpStroke);
//                }

//                OnRendered(new RenderTargetChangedEventArgs(RenderMode.PartialRegion, _currentSegment.CalculateSegmentBoundsSIMD()));
//            }
...
//        //    // 考虑笔刷大小扩展区域
//        //    var brushSize = new Vector2(_thickness);
//        //    return new Rect(
//        //        min.X - brushSize.X,
//        //        min.Y - brushSize.Y,
...
//        //// 绘制笔迹
//        //protected void DrawSegment(CanvasDrawingSession ds, StrokeSegment segment) {
...
//        //    // 单点绘制模式
//        //    if (points.Count == 1) {
//        //        ds.DrawImage(_brush, (float)(points[0].StartPoint.X - _thickness / 2), (float)(points[0].StartPoint.Y - _thickness / 2));
//        //        return;
//        //    }
...
//        //            ds.DrawImage(_brush, (float)(x - _thickness / 2), (float)(y - _thickness / 2));
//        //        }
//        //    }
//        //}
...
//                    // 添加到当前段
//                    _currentSegment.Points.Add(new StrokePoint(smoothed, _blendedColor.ToByteArgb()));
//                    _coveredSegment.Points.Add(new StrokePoint(smoothed, RenderTarget.GetPixelBytes((int)smoothed.X, (int)smoothed.Y, _thickness, _thickness)));
//                    _lastProcessedPoint = smoothed;

//                    // 段大小控制 (关键修改点)
//                    if (_currentSegment.Points.Count >= _maxSegmentPoints) {
//                        RenderToTarget();
//                        _currentSegment = new StrokeSegment(
//                            new StrokePoint(_lastProcessedPoint, _blendedColor.ToByteArgb()), _thickness);
//                        _coveredSegment = new StrokeSegment(
//                            new StrokePoint(
//                                _lastProcessedPoint, 
//                                RenderTarget.GetPixelBytes((int)_lastProcessedPoint.X, (int)_lastProcessedPoint.Y, _thickness, _thickness)),
//                            _thickness);
//                    }
//                }
//            }
...
//        // 数据结构
//        protected readonly LinkedList<StrokeSegment> _renderableStrokes = new();
//        protected readonly LinkedList<StrokeSegment> _coveredStrokeSegments = new();
//        protected StrokeSegment _currentSegment = null!;
//        protected StrokeSegment _coveredSegment = null!;
