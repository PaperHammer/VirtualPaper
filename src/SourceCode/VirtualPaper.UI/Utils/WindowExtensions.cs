    ...
    public static class WindowExtensions
    {
        ...
        public static bool UseImmersiveDarkModeEx(this Window window, bool enabled)
        {
            ...
            if (IsWindows10OrGreater(17763))
            {
                ...
                status = Native.DwmSetWindowAttribute(hwnd, (int)attribute, ref useImmersiveDarkMode, sizeof(int)) == 0;
        ...
        private static void LoadIcon(string iconName, Window window)
        {
            ...
            IntPtr hIcon = Native.LoadImage(IntPtr.Zero, iconName,
                      IMAGE_ICON, 32, 32, LR_LOADFROMFILE);

            _ = Native.SendMessage(hwnd, (int)Native.WM.SETICON, (IntPtr)0, hIcon);
        }
